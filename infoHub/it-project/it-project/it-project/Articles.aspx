<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="Articles.aspx.cs" Inherits="it_project.Articles" %>
                    ...
                    <ItemTemplate>
                        <article class="articles">
                            <section class="article-content">
                                ...
                                <ajaxToolkit:Rating ID="RatingControl" runat="server"
                                    CurrentRating="0"
                                    MaxRating="5"
