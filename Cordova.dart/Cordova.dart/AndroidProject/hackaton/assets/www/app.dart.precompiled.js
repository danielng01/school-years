...
["_js_helper", "dart:_js_helper", , H, {
  ...
  ReflectionInfo_sortedIndex_closure: {
    "^": "Closure:34;box_0,this_1,positions_2",
...
["accelerometer", "lib/accelerometer.dart", , V, {
  "^": "",
  Acceleration: {
    "^": "Object;x,y,z,timestamp",
    toString$0: function(_) {
      return "(" + H.S(this.timestamp) + ": " + H.S(this.x) + ", " + H.S(this.y) + ", " + H.S(this.z) + ")";
    }
  },
  Accelerometer: {
    "^": "Object;_accelerometer",
    watchAcceleration$3: function(success, error, options) {
      var t1, opts;
      t1 = P.LinkedHashMap_LinkedHashMap$_literal(["frequency", options.frequency], null, null);
      opts = P._wrapToDart(P.JsObject__convertDataTree(t1));
      return this._accelerometer.callMethod$2("watchAcceleration", [new V.Accelerometer_watchAcceleration_closure(success), error, opts]);
    },
    Accelerometer$_$0: function() {
      var t1 = J.$index$asx(J.$index$asx($.get$context(), "navigator"), "accelerometer");
      this._accelerometer = t1;
      if (t1 == null)
        throw H.wrapException(P.StateError$("Not ready yet."));
    }
  },
  Accelerometer_watchAcceleration_closure: {
    "^": "Closure:29;success_0",
    call$1: [function(p) {
      var t1 = J.getInterceptor$asx(p);
      return this.success_0.call$1(new V.Acceleration(t1.$index(p, "x"), t1.$index(p, "y"), t1.$index(p, "z"), t1.$index(p, "timestamp")));
...
["", "app.dart", , S, {
  "^": "",
  main: [function() {
    document.querySelector("#sample_text_id").textContent = "Hello from dart";
    J.$index$asx($.get$context(), "document");
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(document, "deviceready", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(S.deviceReady$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 9],
  deviceReady: [function($event) {
    var t1;
    J.set$height$x(document.querySelector("#accel").style, "100px");
    P.print("event = " + H.S($event));
    P.print("device is ready");
    J.set$backgroundColor$x(document.querySelector("body").style, "aliceblue");
    window.alert("Cordova loaded");
    t1 = J.get$onClick$x(document.querySelector("#camera_btn"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new S.deviceReady_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#vibrate_btn"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new S.deviceReady_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#beep_btn"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new S.deviceReady_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    S.accessAccelerometer();
  }, "call$1", "deviceReady$closure", 2, 0, 10, 11],
  accessAccelerometer: function() {
    $.get$accelerometer().watchAcceleration$3(new S.accessAccelerometer_closure(), new S.accessAccelerometer_closure0(), new V.AccelerometerOptions(10));
  },
  onCameraSuccess: [function(imageData) {
  }, "call$1", "onCameraSuccess$closure", 2, 0, 12],
  onCameraError: [function(error) {
  }, "call$1", "onCameraError$closure", 2, 0, 12, 13],
  deviceReady_closure: {
    "^": "Closure:39;",
    call$1: [function(evt) {
      $.get$camera().getPicture$2(S.onCameraSuccess$closure(), S.onCameraError$closure());
    }, "call$1", null, 2, 0, null, 38, "call"],
    $isFunction: true
  },
  deviceReady_closure0: {
    "^": "Closure:39;",
    call$1: [function(evt) {
      $.get$notification()._notification.callMethod$2("vibrate", [7000]);
    }, "call$1", null, 2, 0, null, 38, "call"],
    $isFunction: true
  },
  deviceReady_closure1: {
    "^": "Closure:39;",
    call$1: [function(evt) {
      $.get$notification()._notification.callMethod$2("beep", [3]);
    }, "call$1", null, 2, 0, null, 38, "call"],
    $isFunction: true
  },
  accessAccelerometer_closure: {
    "^": "Closure:40;",
    call$1: function(acc) {
      document.querySelector("#accel").textContent = "Accelerometer\n" + ("x:" + H.S(acc.x) + "\n") + ("y:" + H.S(acc.y) + "\n") + ("z:" + H.S(acc.z) + "\n");
    },
    $isFunction: true
  },
  accessAccelerometer_closure0: {
    "^": "Closure:32;",
    call$0: [function() {
      return $.get$context().callMethod$2("alert", ["Failed!"]);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  }
},
1],
["camera", "lib/camera.dart", , T, {
  "^": "",
  Camera: {
    "^": "Object;_camera",
    getPicture$3: function(success, error, options) {
      this._camera.callMethod$2("getPicture", [new T.Camera_getPicture_closure(success), error]);
    },
    getPicture$2: function(success, error) {
      return this.getPicture$3(success, error, null);
    },
    Camera$_internal$0: function() {
      var t1 = J.$index$asx(J.$index$asx($.get$context(), "navigator"), "camera");
      this._camera = t1;
      if (t1 == null)
        throw H.wrapException(P.StateError$("Not ready yet."));
    }
  },
  Camera_getPicture_closure: {
    "^": "Closure:29;success_0",
    call$1: [function(p) {
      return this.success_0.call$1(p);
    }, "call$1", null, 2, 0, null, 37, "call"],
    $isFunction: true
  }
}],
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_nullDataHandler$closure", 2, 0, 10, 15],
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 16, 17, 13, 18],
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 16, 17, 13, 18],
    $is_Future: true,
    $isFuture: true,
  ...
  _Future__chainForeignFuture_closure0: {
    ...
    }, "call$1", "call$2", null, null, 2, 2, null, 17, 13, 18, "call"],
    $isFunction: true
  },
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 48, 13, 18],
...
["notification", "lib/notification.dart", , O, {
  "^": "",
  Notification: {
    "^": "Object;_notification",
    Notification$_$0: function() {
      var t1 = J.$index$asx(J.$index$asx($.get$context(), "navigator"), "notification");
      this._notification = t1;
      if (t1 == null)
        throw H.wrapException(P.StateError$("Not ready yet"));
    }
  }
...
V.Acceleration.$isAcceleration = true;
V.Acceleration.$isObject = true;
...
Isolate.$lazy($, "accelerometer", "accelerometer", "get$accelerometer", function() {
  var t1 = new V.Accelerometer(null);
  t1.Accelerometer$_$0();
  return t1;
});
Isolate.$lazy($, "camera", "camera", "get$camera", function() {
  var t1 = new T.Camera(null);
  t1.Camera$_internal$0();
  return t1;
});
...
Isolate.$lazy($, "notification", "notification", "get$notification", function() {
  var t1 = new O.Notification(null);
  t1.Notification$_$0();
  return t1;
});
// Native classes
...
{func: "dynamic__Acceleration", args: [V.Acceleration]},
...
function dart_precompiled($collectedClasses) {
  ...
  Acceleration.builtin$cls = "Acceleration";
  if (!"name" in Acceleration)
    Acceleration.name = "Acceleration";
  $desc = $collectedClasses.Acceleration;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Acceleration.prototype = $desc;
  function Accelerometer(_accelerometer) {
    this._accelerometer = _accelerometer;
  }
  Accelerometer.builtin$cls = "Accelerometer";
  if (!"name" in Accelerometer)
    Accelerometer.name = "Accelerometer";
  $desc = $collectedClasses.Accelerometer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Accelerometer.prototype = $desc;
  function Accelerometer_watchAcceleration_closure(success_0) {
    this.success_0 = success_0;
  }
  Accelerometer_watchAcceleration_closure.builtin$cls = "Accelerometer_watchAcceleration_closure";
  if (!"name" in Accelerometer_watchAcceleration_closure)
    Accelerometer_watchAcceleration_closure.name = "Accelerometer_watchAcceleration_closure";
  $desc = $collectedClasses.Accelerometer_watchAcceleration_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Accelerometer_watchAcceleration_closure.prototype = $desc;
  function AccelerometerOptions(frequency) {
    this.frequency = frequency;
  }
  AccelerometerOptions.builtin$cls = "AccelerometerOptions";
  if (!"name" in AccelerometerOptions)
    AccelerometerOptions.name = "AccelerometerOptions";
  $desc = $collectedClasses.AccelerometerOptions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AccelerometerOptions.prototype = $desc;
  function deviceReady_closure() {
  }
  deviceReady_closure.builtin$cls = "deviceReady_closure";
  if (!"name" in deviceReady_closure)
    deviceReady_closure.name = "deviceReady_closure";
  $desc = $collectedClasses.deviceReady_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  deviceReady_closure.prototype = $desc;
  function deviceReady_closure0() {
  }
  deviceReady_closure0.builtin$cls = "deviceReady_closure0";
  if (!"name" in deviceReady_closure0)
    deviceReady_closure0.name = "deviceReady_closure0";
  $desc = $collectedClasses.deviceReady_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  deviceReady_closure0.prototype = $desc;
  function deviceReady_closure1() {
  }
  deviceReady_closure1.builtin$cls = "deviceReady_closure1";
  if (!"name" in deviceReady_closure1)
    deviceReady_closure1.name = "deviceReady_closure1";
  $desc = $collectedClasses.deviceReady_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  deviceReady_closure1.prototype = $desc;
  function accessAccelerometer_closure() {
  }
  accessAccelerometer_closure.builtin$cls = "accessAccelerometer_closure";
  if (!"name" in accessAccelerometer_closure)
    accessAccelerometer_closure.name = "accessAccelerometer_closure";
  $desc = $collectedClasses.accessAccelerometer_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  accessAccelerometer_closure.prototype = $desc;
  function accessAccelerometer_closure0() {
  }
  accessAccelerometer_closure0.builtin$cls = "accessAccelerometer_closure0";
  if (!"name" in accessAccelerometer_closure0)
    accessAccelerometer_closure0.name = "accessAccelerometer_closure0";
  $desc = $collectedClasses.accessAccelerometer_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  accessAccelerometer_closure0.prototype = $desc;
  ...
  function Camera_getPicture_closure(success_0) {
    this.success_0 = success_0;
  }
  Camera_getPicture_closure.builtin$cls = "Camera_getPicture_closure";
  if (!"name" in Camera_getPicture_closure)
    Camera_getPicture_closure.name = "Camera_getPicture_closure";
  $desc = $collectedClasses.Camera_getPicture_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Camera_getPicture_closure.prototype = $desc;
  ...
  function Notification(_notification) {
